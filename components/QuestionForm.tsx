...
const QuestionForm = ({
    ...
    const submit = async (
        ...
        // Attachment is optional during update
        if (
            !formData.title ||
            !formData.content ||
            !formData.authorId
        ...
        if (Array.from(formData.tags).join(",").length > 50) {
            setError("Tags must be 50 characters or fewer in total.");
            return;
        }
        ...
        >
            ...
            <LabelInputContainer>
                ...
                <Label htmlFor="image">
                    ...
                    <small>
                        Add image to your question to make it
